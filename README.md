...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6038d0baac56b00016ab1420
...
To start editing your site, you can use the Sanity interface at https://eppo-heem-8d0ba.sanity.studio/.
...
Generated at `2021-02-26T10:46:02.956Z` by Stackbit version `0.3.50`.